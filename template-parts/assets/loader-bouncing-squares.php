<?php
/**
 * Template part for displaying bouncing squares as loading icon
 *
...
<div class="loader bouncing-squares">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
        <rect fill="#009BC6" stroke="#009BC6" stroke-width="10" width="30" height="30" x="25" y="50">
        ...
        <rect fill="#009BC6" stroke="#009BC6" stroke-width="10" width="30" height="30" x="85" y="50">
        ...
        <rect fill="#009BC6" stroke="#009BC6" stroke-width="10" width="30" height="30" x="145" y="50">
